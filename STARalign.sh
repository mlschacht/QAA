...
#SBATCH --job-name=Align_STAR_campy            #optional: job name
#SBATCH --output=Align_STAR_campy_%j.out       #optional: file to store stdout from job, %j adds the assigned jobID
#SBATCH --error=vAlign_STAR_campy_%j.err        #optional: file to store stderr from job, %j adds the assigned jobID
